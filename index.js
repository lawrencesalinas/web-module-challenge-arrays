...
console.log(addFlavor(originalFlavors, 'egg'));
...
const newArr = []
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        if (currentString.toLowerCase().includes(string.toLowerCase())) {
            newArr.push(currentString);
        }
    }
return newArr;
}
const testArr = ["Chocolate", "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon", "Vanilla", "Vanilla Machiato"]
console.log(filterByWord(testArr, 'Chocolate'))
console.log(filterByWord(testArr, 'Vanilla'))
console.log(filterByWord(testArr, 'vanilla'))
console.log(filterByWord(testArr, 'Machiato'))
